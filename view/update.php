...
<body>
    <div class="container">
        <?php
            include 'koneksi.php';
            $id = $_GET['kode_item'];
            $data = mysqli_query($koneksi,"select * from barang where id='$kode_item'");
            while($d = mysqli_fetch_array($data)){
            $barang=explode(',', $d['hobi']);
        ?>
            ...
            <div class="card-body">
                <form method="post" action="proses_update.php" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="hidden" name="id" value="<?php echo $d['kode_item'] ?>">
                        <label for="nama">Nama :</label>
                        <input type="text" name="nama" class="form-control" id="nama" value="<?php echo $d['barang'] ?>" placeholder="Nama Siswa" required>
                    </div>
                    <div class="form-group">
                        <label for="umur">Umur :</label>
                        <input type="number" name="umur" class="form-control" id="umur" value="<?php echo $d['hargaumum'] ?>" placeholder="Umur Siswa"
                            required>
                    </div>
                    <div class="form-group">
